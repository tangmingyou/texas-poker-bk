...
var file_poker_proto_rawDesc = []byte{
	...
	0x67, 0x22, 0x1b, 0x0a, 0x07, 0x52, 0x65, 0x73, 0x46, 0x61, 0x69, 0x6c, 0x12, 0x10, 0x0a, 0x03,
	0x6d, 0x73, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x23,
...
var file_poker_proto_goTypes = []interface{}{
	...
	(*Ping)(nil),           // 1: api.Ping
	(*Pong)(nil),           // 2: api.Pong
	(*ResFail)(nil),        // 3: api.ResFail
	(*ReqIdentity)(nil),    // 4: api.ReqIdentity
